...
public class MySQLTraditionalDataLoader {
	...
	private static void prepareData() {
		...
		String pattern = "INSERT INTO data (taxi_id, timestamp, latitude, longitude) VALUES ({0},''{1}'',{2},{3})";
		String splitted[];

		for (int i = 0; i < qtd; i++) {
			splitted = dataLines.get(i).split(",");
			insertLines.add(MessageFormat.format(pattern, splitted));
		}
	}
